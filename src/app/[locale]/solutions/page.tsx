  ...
  return (
    <>
      ...
      <section className="solutions-grid">
        {[1, 2].map((i) => (
          <div key={i} className="solution-card">
            ...
            <div className="content-placeholder">Solution Content</div>
          </div>
        ))}
      </section>
      ...
      <style jsx>{`
        ...
        .solutions-grid { padding: 60px 24px; background: #f8fafc; display: grid; grid-template-columns: repeat(2, 1fr); gap: 40px; max-width: 1200px; margin: 0 auto; }
        .solution-card { background: #fff; border-radius: 8px; overflow: hidden; }
        ...
        .content-placeholder { padding: 32px; color: #666; }
      `}</style>
    </>
  );
}
