...
export default function AdminPage() {
  ...
  // Hardcoded initial values - match content.json structure
  const [content, setContent] = useState({
    hero: {
      title: 'Professional HDPE Plastic Netting Manufacturer Since 2005',
      subtitle: 'Leading manufacturer of construction safety nets, agricultural nets, and specialty plastic netting solutions. Exporting to 50+ countries worldwide.',
      cta1: 'Get Free Quote',
      cta2: 'View Products'
    },
    about: {
      ...
      <div style={{ display: "flex", height: "calc(100vh - 80px)" }}>
        ...
        <aside style={{ width: "240px", backgroundColor: "white", borderRight: "1px solid #e0e0e0", padding: "20px 0" }}>
          ...
          <div style={{ marginTop: "30px", padding: "0 24px" }}>
            <p style={{ fontSize: "12px", color: "#9ca3af", fontWeight: "600", marginBottom: "10px", textTransform: "uppercase" as const }}>快速链接</p>
            ...
            <div style={{ maxWidth: "800px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                <div>
                  ...
                  <textarea 
                    value={content.about.features} 
                    onChange={e => updateField('about', 'features', e.target.value)} 
                    rows={3} 
                    style={textareaStyle} 
                  />
                </div>
            ...
            <div style={{ maxWidth: "800px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                <div>
                  ...
                  <input type="email" value={content.contact.email} onChange={e => updateField('contact', 'email', e.target.value)} style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>📱 电话</label>
                  <input type="text" value={content.contact.phone} onChange={e => updateField('contact', 'phone', e.target.value)} style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>💬 WhatsApp</label>
                  <input type="text" value={content.contact.whatsapp} onChange={e => updateField('contact', 'whatsapp', e.target.value)} style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>📍 地址</label>
                  <textarea value={content.contact.address} onChange={e => updateField('contact', 'address', e.target.value)} rows={3} style={textareaStyle} />
                </div>
                <div>
                  <label style={labelStyle}>⏰ 工作时间</label>
                  <input type="text" value={content.contact.workingHours} onChange={e => updateField('contact', 'workingHours', e.target.value)} style={inputStyle} />
                </div>
              </div>
            </div>
          )}
            ...
            <div style={{ maxWidth: "800px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                <div>
                  ...
                  <input type="text" value={content.footer.company} onChange={e => updateField('footer', 'company', e.target.value)} style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>版权信息</label>
                  <input type="text" value={content.footer.copyright} onChange={e => updateField('footer', 'copyright', e.target.value)} style={inputStyle} />
                </div>
              </div>
            </div>
          )}
